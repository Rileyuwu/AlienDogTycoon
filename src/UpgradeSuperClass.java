...
public class UpgradeSuperClass {
    ...
    public UpgradeSuperClass() {
        ...
        growthChamberUpgraded = false; //Logic of bools will have to be reviwed - Riley
    ...
    void upgradeGrowthChamber() {
        if (growthChamberLevel == 3) {
            System.out.println("Cannot be upgraded!");
        }   else if (playerMoney >= GROWTH_CHAMBER_COST && !growthChamberUpgraded) {
            playerMoney -= GROWTH_CHAMBER_COST;
            growthChamberUpgraded = true;
            growthChamberLevel++;
